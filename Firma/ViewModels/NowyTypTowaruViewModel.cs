...
{
    public class NowyTypTowaruViewModel : JedenViewModel<TypTowaru>, IDataErrorInfo
    {
        
        #region Konstruktor
        public NowyTypTowaruViewModel()
        : base("Dodawanie nowego typu towaru")
        {
            Item = new TypTowaru();
        }
        #endregion
