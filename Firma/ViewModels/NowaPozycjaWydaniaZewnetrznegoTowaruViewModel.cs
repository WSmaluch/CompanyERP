...
{
    public class NowaPozycjaWydaniaZewnetrznegoTowaruViewModel : JedenViewModel<PozycjaWydaniaZewnetrznegoTowaru>, IDataErrorInfo
    {
        #region Commands
        ...
        #endregion
        #region Konstruktor
        public NowaPozycjaWydaniaZewnetrznegoTowaruViewModel()
        : base("Nowa pozycja wydania zewnetrznego towaru")
        {
            Item = new PozycjaWydaniaZewnetrznegoTowaru();
        ...
        public IQueryable<KeyAndValue> JednostkiComboBoxItems
        {
            get
            {
                return
        ...
        public override void Save()
        {
            ...
            Item.IdJednostkiMiary = 2;
            Db.PozycjaWydaniaZewnetrznegoTowaru.AddObject(Item);
            Db.SaveChanges();
        }
        #endregion
        #region Helpers
