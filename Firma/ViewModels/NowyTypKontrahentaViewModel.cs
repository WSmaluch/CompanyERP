...
{
    public class NowyTypKontrahentaViewModel : JedenViewModel<TypKontrahenta>, IDataErrorInfo
    {

        #region Konstruktor
        public NowyTypKontrahentaViewModel()
        : base("Dodawanie nowego typu kontrahenta")
        {
            Item = new TypKontrahenta();
        }
        #endregion
        #region Properties
        public string Nazwa
        ...
        public override void Save()
        {
            ...
            Db.TypKontrahenta.AddObject(Item);
            Db.SaveChanges();
        }
        #endregion
    }
