...
{
    public class NoweWydanieZewnetrzneViewModel : JedenViewModel<WydanieZewnetrzne>, IDataErrorInfo
    {
        #region Commands
        ...
        public NoweWydanieZewnetrzneViewModel()
            :base("Dodawanie wydania zewnetrznego")
        {
            Item = new WydanieZewnetrzne();
        ...
        public override void Save()
        {
            ...
            Db.WydanieZewnetrzne.AddObject(Item);
            Db.SaveChanges();
        }
        #endregion
        #region Helpers
